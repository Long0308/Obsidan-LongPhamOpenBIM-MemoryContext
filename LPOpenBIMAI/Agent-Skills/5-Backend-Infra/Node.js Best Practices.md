...
tags:
  ...
  - nodejs
group: Backend
role: Node.js development principles â€” framework selection, async patterns, security, architecture
source: .agent/skills/nodejs-best-practices/SKILL.md
---
...
- **Related:** [[Python Patterns]], [[API Patterns]], [[React Best Practices]]
- **Used by:** [[Backend Specialist]]

## NhÃ³m
Backend | Xem thÃªm táº¡i [[AGENT_SWARM|Agent Swarm MOC]]
