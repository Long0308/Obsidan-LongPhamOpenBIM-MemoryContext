...
tags:
  ...
  - python
group: Backend
role: Python development principles â€” framework selection, async, type hints, project structure
source: .agent/skills/python-patterns/SKILL.md
---
...
- **Related:** [[Node.js Best Practices]], [[API Patterns]], [[Database Design]]
