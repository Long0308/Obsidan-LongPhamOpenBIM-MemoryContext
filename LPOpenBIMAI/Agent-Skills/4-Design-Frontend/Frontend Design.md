...
tags:
  ...
  - ux
group: Design
role: Design thinking and decision-making for web UI â€” color, typography, UX psychology, layout
source: .agent/skills/frontend-design/SKILL.md
---
...
|------|--------|--------------|
| ux-psychology.md | ðŸ”´ **REQUIRED** | Always read first! |
| color-system.md | âšª Optional | Color/palette decisions |
| typography-system.md | âšª Optional | Font selection/pairing |
| visual-effects.md | âšª Optional | Glassmorphism, shadows, gradients |
| animation-guide.md | âšª Optional | Animation needed |
| motion-graphics.md | âšª Optional | Lottie, GSAP, 3D |
| decision-trees.md | âšª Optional | Context templates |
...
- **Related:** [[UI-UX Pro Max]], [[Web Design Guidelines]], [[Gemini-King-Mode]], [[Animation Guide]]
